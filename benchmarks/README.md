...
利用者生成の日本語218文書のレビュー完了版について、修正前の値は
[2026-09-23の測定結果](results/2026-09-23-generated-ja-218.md)、改善後の値と前後比較は
[検出改善の測定報告](results/2026-09-23-detection-improvements.md)に記録しています。
GiNZA有効・辞書なしで前後各3回測定し、精度、処理時間、分類別の失敗傾向を保存しています。
